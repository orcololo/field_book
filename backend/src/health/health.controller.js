...
var HealthController = function () {
    ...
    var HealthController = _classThis = /** @class */ (function () {
        function HealthController_1(health, mongoose) {
            this.health = (__runInitializers(this, _instanceExtraInitializers), health);
            this.mongoose = mongoose;
        }
        HealthController_1.prototype.check = function () {
            var _this = this;
            return this.health.check([function () { return _this.mongoose.pingCheck('mongodb'); }]);
        };
    ...
    (function () {
        ...
        _check_decorators = [(0, common_1.Get)(), (0, terminus_1.HealthCheck)(), (0, swagger_1.ApiOperation)({ summary: 'Health check endpoint' })];
