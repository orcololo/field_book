...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, logger, apiPrefix, swaggerConfig, document_1, port;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (configService.get('NODE_ENV') !== 'production') {
                        ...
                        swagger_1.SwaggerModule.setup("".concat(apiPrefix, "/docs"), app, document_1);
                        logger.log("Swagger docs available at /".concat(apiPrefix, "/docs"));
                    }
                    port = configService.get('PORT', 3000);
                    return [4 /*yield*/, app.listen(port)];
                case 2:
                    _a.sent();
                    logger.log("Application running on port ".concat(port));
                    return [2 /*return*/];
            }
        });
    });
