...
var CreateUserDto = function () {
    ...
    return _a = /** @class */ (function () {
            function CreateUserDto() {
                ...
                __runInitializers(this, _institution_extraInitializers);
            }
            return CreateUserDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [(0, swagger_1.ApiProperty)({ example: 'João Silva' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _email_decorators = [(0, swagger_1.ApiProperty)({ example: 'joao@example.com' }), (0, class_validator_1.IsEmail)()];
            _password_decorators = [(0, swagger_1.ApiProperty)({ example: 'strongPassword123', minLength: 8 }), (0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(8)];
            _role_decorators = [(0, swagger_1.ApiPropertyOptional)({ enum: user_schema_1.UserRole, example: user_schema_1.UserRole.COLLECTOR }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(user_schema_1.UserRole)];
            _institution_decorators = [(0, swagger_1.ApiPropertyOptional)({ example: 'Universidade Federal' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
