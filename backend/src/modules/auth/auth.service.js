...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            tokens = _a.sent();
                            return [4 /*yield*/, this.usersService.setRefreshToken(user.id, tokens.refreshToken)];
                        case 3:
                            _a.sent();
        ...
        AuthService_1.prototype.refreshTokens = function (refreshTokenDto) {
            return __awaiter(this, void 0, void 0, function () {
                var payload, user, isTokenValid, tokens, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, bcrypt.compare(refreshTokenDto.refreshToken, user.refreshToken)];
                        case 2:
        ...
        AuthService_1.prototype.logout = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersService.setRefreshToken(userId, null)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, Promise.all([
                                this.jwtService.signAsync(__assign({}, payload), {
